...
export default function Contact() {
  return (
    <section id="contact" className="bg-black px-6 py-20">
      <div className="mx-auto max-w-4xl rounded-2xl border border-white/10 bg-zinc-900 p-6 text-center sm:p-10">
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          <a
            ...
            rel="noreferrer"
            aria-label="WhatsApp"
            className="flex h-12 w-12 items-center justify-center rounded-full bg-green-600/90 text-white transition hover:scale-105 hover:bg-green-500 hover:shadow-[0_0_20px_rgba(34,197,94,0.6)] sm:h-12 sm:w-auto sm:gap-2 sm:rounded-xl sm:px-5"
          >
            <WhatsAppIcon />
          ...
          <a
            ...
            aria-label="Email"
            className="flex h-12 w-12 items-center justify-center rounded-full border border-white/20 bg-white/5 text-white transition hover:scale-105 hover:bg-white/10 hover:shadow-[0_0_15px_rgba(255,255,255,0.2)] sm:h-12 sm:w-auto sm:gap-2 sm:rounded-xl sm:px-5"
          >
            <MailIcon />
          ...
          <a
            ...
            className="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 text-white transition hover:scale-105 hover:opacity-90 hover:shadow-[0_0_20px_rgba(255,0,100,0.6)] sm:h-12 sm:w-auto sm:gap-2 sm:rounded-xl sm:px-5"
          >
            <InstagramIcon />
